...
public class RootButtonUI<T extends Button> extends AbstractComponentUI<Button> {
    ...
    public void renderComponent(Button component, FontRenderer ff) {
        ...
        CerealGUI.fontRenderer.drawString(component.getWidth() / 2 - CerealGUI.fontRenderer.getStringWidth(component.getName()) / 2, 0, component.isPressed() ? downColour : idleColour, component.getName());
    ...
    public void handleAddComponent(Button component, Container container) {
        component.setWidth(CerealGUI.fontRenderer.getStringWidth(component.getName()) + 28);
        component.setHeight(CerealGUI.fontRenderer.getFontHeight()+2);
    }
}