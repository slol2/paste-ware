...
import me.cereal.utility.gui.cereal.RootSmallFontRenderer;
import me.cereal.utility.gui.cereal.component.ColorizedCheckButton;
...
//        RenderHelper.drawRoundedRectangle(0,0,component.getWidth(), component.getHeight(), 3f);
        ...
        ff.drawString(component.getWidth() / 2 - CerealGUI.fontRenderer.getStringWidth(component.getName()) / 2, 0, component.isPressed() ? downColour : idleColour, component.getName());
