package me.cereal.utility.gui.cereal;

import com.mojang.realmsclient.gui.ChatFormatting;
import me.cereal.utility.CerealMod;
import me.cereal.utility.command.Command;
import me.cereal.utility.gui.cereal.component.ActiveModules;
import me.cereal.utility.gui.cereal.component.Radar;
import me.cereal.utility.gui.cereal.component.SettingsPanel;
import me.cereal.utility.gui.cereal.theme.cereal.CerealTheme;
...
import me.cereal.utility.gui.rgui.component.listen.TickListener;
...
import me.cereal.utility.util.Pair;
 ...
 */
public class CerealGUI extends GUI {
    ...
    public void initializeGUI() {
        ...
        this.addMouseListener(new MouseListener() {
            ...
            @Override
            public void onMouseDown(MouseButtonEvent event) {
                List<SettingsPanel> panels = ContainerHelper.getAllChildren(SettingsPanel.class, me.cereal.utility.gui.cereal.CerealGUI.this);
        ...
        information.addTickListener(() -> {
            information.setText("");
            information.addLine("\u00A7bCereal Utility Mod\u00A73 " + CerealMod.MODVER);
        ...
        entityLabel.addTickListener(new TickListener() {
            ...
            public void onTick() {
                ...
                final Map<String, Integer> entityCounts = entityList.stream()
                        ...
                        .collect(Collectors.groupingBy(me.cereal.utility.gui.cereal.CerealGUI::getEntityName,
