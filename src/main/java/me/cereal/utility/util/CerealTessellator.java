...
public class CerealTessellator extends Tessellator {

    public static CerealTessellator INSTANCE = new CerealTessellator();

    public CerealTessellator() {
        super(0x200000);
    }
    ...
    public static void drawFullBox(AxisAlignedBB bb, BlockPos blockPos, float width, int red, int green, int blue, int alpha) {
        CerealTessellator.drawBox(blockPos, red, green, blue, alpha, 63);
        CerealTessellator.release();
        CerealTessellator.prepare(7);
        CerealTessellator.drawBoundingBox(bb, width, red, green, blue, 255);
    }
    ...
    public static void drawBoundingBox(AxisAlignedBB bb, float width, int argb) {
        ...
        int g = argb >>> 8 & 255;
        int b = argb & 255;
        CerealTessellator.drawBoundingBox(bb, width, r, g, b, a);
    }
