...
public class KamiTessellator extends Tessellator {
    ...
    public static void drawFullBox(AxisAlignedBB bb, BlockPos blockPos, float width, int red, int green, int blue, int alpha) {
        KamiTessellator.drawBox(blockPos, red, green, blue, alpha, 63);
        KamiTessellator.release();
        KamiTessellator.prepare(7);
        KamiTessellator.drawBoundingBox(bb, width, red, green, blue, 255);
    }
    ...
    public static void drawBoundingBox(AxisAlignedBB bb, float width, int argb) {
        ...
        int g = argb >>> 8 & 255;
        int b = argb & 255;
        KamiTessellator.drawBoundingBox(bb, width, r, g, b, a);
    }
